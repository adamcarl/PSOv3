...
class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.MyViewHolder> {
    ...
    TransactionAdapter(Context mContext, List<Transactions> transactionList, OnRecyclerItemClickListener onRecyclerItemClickListener) {
...
//        holder.transType.setText(transactions.getTransactionType());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView transNumber, transType, transDateTime;
        CardView cv;
