...
public class DB_Data extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase arg0) {
        ...
        arg0.execSQL("CREATE TABLE "+ TABLE_CASHIER +" ("+_ID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+ COLUMN_CASHIER_NUMBER +" INTEGER NOT NULL UNIQUE, "+ COLUMN_CASHIER_NAME +" TEXT NOT NULL, "+ COLUMN_CASHIER_POSITION +" INTEGER NOT NULL,"+ COLUMN_CASHIER_PASSWORD +" TEXT NOT NULL );");
    ...
    public void addCashier(String Name,String UserNum, String Pass, int Pos){
        cv.clear();
