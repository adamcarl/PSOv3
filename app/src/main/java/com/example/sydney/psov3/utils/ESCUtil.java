package com.example.sydney.psov3.utils;

import android.graphics.Bitmap;

import java.io.ByteArrayOutputStream;

//Commonly used instruction package
public class ESCUtil {
	...
	/**
	 *
	 Print a single 2D code sunmi custom instruction
	 * @param code: two-dimensional code data
	 * @param modulesize: two-dimensional code block size (unit: point, the value of 1 to 16)
	 * @param errorlevel: two-dimensional code error correction level (0 to 3)
	...
	/**
	 *
	 Horizontal two two-dimensional code sunmi custom instructions
	 * @param code1: two-dimensional code data
	 * @param code2: two-dimensional code data
	 * @param modulesize: two-dimensional code block size (unit: point, the value of 1 to 16)
	 * @param errorlevel: two-dimensional code error correction level (0 to 3)
	 * 0 - Error Correction Level L (7%)
	 * 1 - Error Correction Level M (15%)
	...
	/**
	 * Raster prints two-dimensional code
	 */
	...
	/**
	 *
	 Print a one-dimensional bar code
	 */
	...
	/**
	 * Jump Specifies the number of rows
	 */
	...
	*Single byte mode is off
	...
	/**
	 * Set the single-byte character set
	 */
	...
	private static byte[] getBytesForPrintQRCode(boolean single){
		//Prints a two-dimensional code that has been stored
		byte[] dtmp;
		if(single){		//The same line only prints a QRCode, followed by a new line
			dtmp = new byte[9];
			dtmp[8] = 0x0A;
		}else{
			dtmp = new byte[8];
	...
	private static byte[] getQCodeBytes(String code) {
		//Two-dimensional code is stored in instruction
		ByteArrayOutputStream buffer = new ByteArrayOutputStream();
		try {
			byte[] d = code.getBytes("UTF-8"); //GB18030
			int len = d.length + 3;
